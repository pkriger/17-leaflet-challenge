 ...
 * Markers: Your data markers should reflect: 
    * the magnitude of the earthquake by their size 
    * depth of the earth quake by color 
    * Note: Earthquakes with higher magnitudes should appear larger and earthquakes with greater depth should appear darker in color.

   * **HINT** the depth of the earth can be found as the third coordinate for each earthquake.

 * Popups: that provide additional information about the earthquake when a marker is clicked.

 * Legend: Create a legend that will provide context for your map data.
